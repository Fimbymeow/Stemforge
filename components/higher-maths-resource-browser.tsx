...
import { getActiveSubject, getActiveSkillPath, getAllSkillPaths, getResourceSummaryForSkillPath, getResourcesForSkillPath, getSkillPathHref } from "@/lib/learning-paths";
        ...
        <section className="grid content-start gap-4">
          <header>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h1 className="m-0 text-2xl font-extrabold leading-tight">{resource.title}</h1>
                <p className="mt-1 text-base text-muted">Browse available resources by topic.</p>
              </div>
            </div>
          </header>
          <label className="relative block">
            ...
            <input
              ...
              className="min-h-10 w-full rounded-xl border border-line bg-white pl-11 pr-4 text-sm outline-none focus:border-forge"
            />
          </label>
  ...
  return (
    <div className={`grid grid-cols-[1fr_auto] items-center gap-3 border-b border-line px-4 py-3 ${depth ? "pl-8" : ""}`}>
      <div className="flex items-center gap-3">
        ...
        <span className="grid size-9 place-items-center rounded-xl bg-forge-soft text-forge">{icon}</span>
        <strong>{title}</strong>
      </div>
