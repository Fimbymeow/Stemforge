  ...
  return (
    <LegalPage title="Terms of Use" summary="The basic rules for using Orthic during its public beta.">
      ...
      <LegalSection title="Learning content and intellectual property">
        <p>Orthic learning materials, software and branding are protected by applicable intellectual-property rights. You may use the service for personal learning and ordinary teaching support, but must not republish, sell, scrape or falsely present its materials as official examination-board content.</p>
      </LegalSection>
      ...
      <LegalSection title="Data and ending use">
        <p>You can stop using the service at any time and use the available browser and account learning-data controls. Authentication-identity deletion currently requires assistance through the in-product Send feedback route. Orthic may need to retain limited records where required for security, legal compliance or resolving disputes.</p>
      </LegalSection>
