      ...
      <div className="mx-auto grid min-w-0 max-w-[1240px] grid-cols-[minmax(0,1fr)] gap-6">
        <header className="grid gap-4">
          ...
          <div className="grid grid-cols-[40px_minmax(0,1fr)] items-center gap-3">
            <span className="grid size-10 place-items-center rounded-lg border border-forge-soft bg-forge-soft text-forge"><ListChecks aria-hidden="true" className="size-5" /></span>
            <div>
