...
test("V3 completion writes one V7 path snapshot and refresh does not duplicate it", async ({ page }) => {
...
test("a corrupt V4 snapshot migrates and is repaired on the next valid submission without crashing", async ({ page }) => {
