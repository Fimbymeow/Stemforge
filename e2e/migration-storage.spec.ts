...
test("V1 progress stays visible and continued activity writes V6 safely", async ({ page }) => {
...
test("partially malformed V2 keeps valid records and repairs into V6 on the next save", async ({ page }) => {
