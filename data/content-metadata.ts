...
export const INITIAL_CONTENT_REVISION = 1;

export const ACTIVE_CONTENT_STATUS: ContentStatus = "active";
export const ARCHIVED_CONTENT_STATUS: ContentStatus = "archived";
