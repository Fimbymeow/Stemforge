...
export const chainRulePackage: SkillPackageManifest = {
  ...
  sources: [
    ...
    },
    {
      ...
      expectedSourceHash: "6aa38c610b2827cdd34ec22476558baa6b9e44419e61e8b04bf6da344fe1c769",
    },
    {
      kind: "applications",
      sourcePath: "content-drafts/higher-maths/calculus/chain-rule-v6.md",
  ...
  qaEvidence: {
    ...
    // Worked solutions were confirmed to use Orthic's own explanatory-prose house style
