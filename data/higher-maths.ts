...
import { chainRuleStageQuestionIds } from "@/content/questions/higher-maths/chain-rule";
      ...
      specAreas: [
        {
          ...
          skillPaths: [
            ...
            },
            {
              ...
              recommendedAction: {
                title: "Foundations",
                copy: "Start with recognising composite functions before applying the chain rule.",
                href: "/question/hm-calc-diff-chain-f-001",
                label: "Start Foundations",
              },
              sidebarLinks: [
                {
              ...
              practiceSets: [
                {
                  id: "chain-rule-practice-set-1",
                  contentRevision: INITIAL_CONTENT_REVISION,
                  contentStatus: ACTIVE_CONTENT_STATUS,
                  title: "Chain rule practice set",
                  description: "A short set covering recognition, coefficients and fractional powers using the chain rule.",
                  stage: "Foundations",
                  questionCount: 10,
                  estimatedMinutes: 30,
                  href: "/question/hm-calc-diff-chain-f-001",
              ...
              learningStages: [
                {
                  id: "chain-rule-stage-foundations",
                  stageVersion: INITIAL_STAGE_VERSION,
                  contentStatus: ACTIVE_CONTENT_STATUS,
                  title: "Foundations",
                  label: "Foundations",
                  name: "Foundations",
                  description: "Build fluency recognising and differentiating composite functions with the chain rule.",
                  questionIds: [...chainRuleStageQuestionIds.foundations],
                  questions: chainRuleStageQuestionIds.foundations.length,
                  completed: 0,
                  button: "Start Foundations",
                  accent: "green",
                  status: "available",
                ...
                {
                  id: "chain-rule-stage-applications",
                  stageVersion: INITIAL_STAGE_VERSION,
                  contentStatus: ACTIVE_CONTENT_STATUS,
                  title: "Applications",
                  label: "Applications",
                  name: "Applications",
                  description: "Apply the chain rule to coefficients, negative and fractional powers, and gradient evaluation.",
                  questionIds: [...chainRuleStageQuestionIds.applications],
                  questions: chainRuleStageQuestionIds.applications.length,
                  completed: 0,
                  button: "Start Applications",
                  accent: "blue",
                  status: "available",
                  progressStatus: "not_started",
                  estimatedMinutes: 20,
                  href: "/question/hm-calc-diff-chain-a-001",
                },
                {
                  id: "chain-rule-stage-past-paper-style",
                  stageVersion: INITIAL_STAGE_VERSION,
                  contentStatus: ACTIVE_CONTENT_STATUS,
                  title: "Past Paper-style Questions",
                  label: "Past Paper-style Questions",
                  name: "Past Paper-style Questions",
                  description: "Practise original multi-step chain rule questions in the style of Higher Maths papers.",
                  questionIds: [...chainRuleStageQuestionIds.pastPaperStyle],
                  questions: chainRuleStageQuestionIds.pastPaperStyle.length,
                  completed: 0,
                  button: "Start Past Paper-style Questions",
                  accent: "orange",
                  status: "available",
                  progressStatus: "not_started",
                  estimatedMinutes: 25,
                  href: "/question/hm-calc-diff-chain-ppq-003",
                },
              ],
            },
            {
            ...
            },
            {
              ...
              pathVersion: INITIAL_PATH_VERSION,
              contentStatus: ACTIVE_CONTENT_STATUS,
              name: "Stationary Points and Their Nature",
              description: "Find stationary points and classify their nature using changes in the sign of the first derivative.",
            ...
            },
            {
              ...
              contentStatus: ACTIVE_CONTENT_STATUS,
              name: "Tangents",
              description: "Find the equation of a tangent to a curve at a given point using the derivative.",
            ...
            createHigherMathsPlaceholder({
              ...
              specificationStrandId: higherMathsCalculusStrandIds.investigatingFunctions,
              displayOrder: 5,
              name: "Curve Sketching Using Calculus",
        ...
        },
        {
          ...
          skillPaths: [
            ...
            {
              slug: "integration-composite-power",
              specificationStrandId: higherMathsCalculusStrandIds.integratingFunctions,
              displayOrder: 2,
              pathVersion: INITIAL_PATH_VERSION,
              contentStatus: ACTIVE_CONTENT_STATUS,
              name: "Integration of Bracket Powers",
              description: "Integrate powers of a linear expression such as (ax + b)^n using the reverse chain rule.",
              href: "/subjects/higher-maths/calculus/integration/integration-composite-power",
              status: "coming-soon",
              isAvailable: false,
              progress: 0,
              completed: 0,
            ...
            {
              slug: "trigonometric-integration",
              specificationStrandId: higherMathsCalculusStrandIds.integratingFunctions,
              displayOrder: 3,
              pathVersion: INITIAL_PATH_VERSION,
              contentStatus: ACTIVE_CONTENT_STATUS,
              name: "Trigonometric Integration",
              description: "Integrate scalar multiples of sine and cosine, including composite linear arguments.",
              href: "/subjects/higher-maths/calculus/integration/trigonometric-integration",
              status: "coming-soon",
              isAvailable: false,
              progress: 0,
              completed: 0,
            ...
            },
            {
              ...
              description: "Solve differential equations of the form dy/dx = f(x), then use an initial condition to determine and use the resulting function.",
            ...
            },
            {
              ...
              pathVersion: INITIAL_PATH_VERSION,
              contentStatus: ACTIVE_CONTENT_STATUS,
              name: "Area Between a Curve and the Axis",
              description: "Use integration to find the area enclosed between a curve and the x-axis.",
              href: "/subjects/higher-maths/calculus/integration/area-under-curve",
              status: "coming-soon",
              isAvailable: false,
              progress: 0,
              completed: 0,
            ...
            },
            {
              ...
              pathVersion: INITIAL_PATH_VERSION,
              contentStatus: ACTIVE_CONTENT_STATUS,
              name: "Area Between Curves or a Line and a Curve",
              description: "Use integration to find the area enclosed between a line and a curve, or between two curves.",
              href: "/subjects/higher-maths/calculus/integration/area-between-curves",
              status: "coming-soon",
              isAvailable: false,
              progress: 0,
              completed: 0,
