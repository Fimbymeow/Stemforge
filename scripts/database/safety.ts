export function assertSafeTestDatabaseUrl(value: string | undefined, developmentUrl = process.env.STEMFORGE_DATABASE_URL) {
  ...
  if (!local && process.env.STEMFORGE_ALLOW_REMOTE_TEST_DATABASE !== "1") {
