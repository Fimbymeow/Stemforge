...
export type SafeErasureRequest = {
  ...
  deletedCounts: { attempts: number; supportEvents: number; guidedSelfAssessments: number; achievementSnapshots: number; reviewEvents: number; flashcardReviews: number; conflicts: number } | null;
