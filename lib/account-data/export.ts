...
export type AccountLearningDataExport = {
  ...
  categoryCounts: { attempts: number; supportEvents: number; guidedSelfAssessments: number; achievementSnapshots: number; reviewEvents: number; retainedConflicts: number };
